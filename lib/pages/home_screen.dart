...
//             return data['name'] ?? 'Danh mục không tên';
//           })
//               .toList();
...
//                 return Center(child: Text("Lỗi tải thông tin người dùng: ${userSnapshot.error}"));
//               }
//               bool isAdmin = false;
...
//                           return Center(child: Text("Lỗi: ${newsSnapshot.error}"));
//                         }
